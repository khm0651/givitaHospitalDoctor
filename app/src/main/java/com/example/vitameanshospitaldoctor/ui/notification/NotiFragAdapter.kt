...
class NotiFragAdapter : RecyclerView.Adapter<NotiFragAdapter.ItemViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        return ItemViewHolder(
            DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.fragment_notification_list_item_layout,parent,false)
        )
    }
    ...
    inner class ItemViewHolder(private val binding: FragmentNotificationListItemLayoutBinding): RecyclerView.ViewHolder(binding.root){
